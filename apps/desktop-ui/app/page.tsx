...
import { Search, Plus, FolderKanban, GitBranch, ArrowRight, ArrowLeftRight } from "lucide-react"
          ...
          <div className="w-full max-w-md">
            ...
            {projects.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-sm text-linear-text-tertiary mb-4">No projects yet</p>
                <button
                  onClick={() => router.push("/projects")}
                  className="inline-flex items-center gap-2 h-9 px-4 rounded-md bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 text-sm font-medium transition-colors"
                >
