        ...
        <div className="border-b border-linear-border">
          <div className="px-4 sm:px-6 py-4">
            ...
            <div className="flex items-start gap-4">
              <div
                className="w-12 h-12 rounded-sm flex items-center justify-center flex-shrink-0 border border-linear-border"
        ...
        <div className="flex-1 overflow-auto">
          <div className="max-w-3xl mx-auto p-6 space-y-8">
            ...
            <section>
              ...
              <div className="rounded-sm bg-linear-bg-secondary border border-linear-border overflow-hidden">
                {isLoadingTasks ? (
