      ...
      <header className="min-h-14 border-b border-linear-border flex flex-wrap items-center px-3 sm:px-6 py-2 sm:py-0 bg-linear-bg gap-2 sm:gap-4" data-tauri-drag-region>
        ...
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0 ml-auto">
          <button
            ...
            className="flex items-center gap-1.5 h-8 px-2.5 text-xs rounded-sm bg-linear-bg-tertiary border border-linear-border hover:border-linear-border-hover text-linear-text transition-colors"
          >
