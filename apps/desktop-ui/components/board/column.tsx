...
export function Column({ id, title, taskCount, children, onAddTask, selectionActive, onToggleSelection, onSelectAll, innerRef, droppableProps, isDraggingOver }: ColumnProps) {
  return (
    <div className="flex flex-col h-full border-r border-white/[0.06] last:border-r-0 w-[85vw] flex-none md:w-full md:flex-auto snap-start bg-gradient-to-b from-white/[0.02] to-transparent">
      <div className="flex items-center justify-between px-4 py-3 backdrop-blur-sm bg-white/[0.02] border-b border-white/[0.04] gap-2 flex-nowrap h-12 flex-shrink-0">
