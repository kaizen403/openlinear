...
export function Hero() {
  return (
    <section className="relative min-h-[100svh] flex items-center overflow-hidden">
      ...
      {/* Layer 1 - atmospheric wash: ultra-faint cool tone at top */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_120%_60%_at_50%_-10%,hsl(235_18%_95%/0.5),transparent_70%)]" />

      {/* Layer 2 - depth plane left: barely visible warm undertone */}
      <div className="absolute top-[20%] left-[8%] w-[600px] h-[600px] rounded-full bg-[hsl(235_20%_94%/0.25)] blur-[180px] pointer-events-none" />

      {/* Layer 3 - depth plane right: cool undertone, offset */}
      <div className="absolute bottom-[5%] right-[5%] w-[500px] h-[500px] rounded-full bg-[hsl(220_22%_94%/0.2)] blur-[160px] pointer-events-none" />

      {/* Layer 4 - center light: barely perceptible highlight behind cards */}
      <div className="absolute top-[35%] left-[55%] -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full bg-[hsl(243_20%_96%/0.15)] blur-[200px] pointer-events-none" />

      {/* Layer 5 - very subtle horizon line for grounding */}
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[hsl(228_10%_88%/0.3)] to-transparent" />
      ...
      <div className="relative mx-auto max-w-[76rem] px-6 lg:px-10 pt-40 pb-36 w-full">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-24 items-center">
          ...
          <div className="relative h-[540px] hidden lg:block">
            {/* Ambient glow behind card cluster - very soft */}
            <div className="absolute inset-[-60px] bg-[radial-gradient(circle_at_50%_45%,hsl(240_18%_95%/0.3),transparent_60%)] pointer-events-none" />

            {/* Ground shadow - subtle depth anchor */}
            <div className="absolute bottom-2 left-[12%] right-[12%] h-20 bg-[radial-gradient(ellipse_at_center,hsl(228_15%_88%/0.15),transparent_70%)] blur-3xl pointer-events-none" />
